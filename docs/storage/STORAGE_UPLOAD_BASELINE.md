...
| Queue retries and duplicate completed-upload attach idempotency | `apps/api/test/upload-queue.test.ts`, `apps/api/test/agent-cache-idempotency-routes.test.ts` |
