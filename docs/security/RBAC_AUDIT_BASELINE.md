...
| ---------- | ----------------- | ---------------- |
| `audit:read` | Audit trail reads, detail/action summaries, and filtered/selected CSV export | `apps/api/src/audit-routes.ts`, `apps/web/src/lib/audit-page-helpers.ts` |
