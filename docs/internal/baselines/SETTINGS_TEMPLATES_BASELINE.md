...
- Watchdog policies can be read and updated through RBAC-gated settings routes, including speech, quality anomaly, broadband-noise, channel-correlation, clipping, and flatline controls.
...
| UI workflow              | `apps/web/src/pages/settings.tsx`, `apps/web/src/components/channel-map-template-card.tsx`, `apps/web/src/components/recording-profile-settings-card.tsx`, `apps/web/src/components/watchdog-policy-card.tsx`, `apps/web/src/lib/settings-updates.ts`, `apps/web/src/lib/settings-updates.test.ts`                                                                                                                                                                                                                                                                 |
