...
- Synthetic PCM calibration fixtures assert voice, silence, estimated SNR, hum/static likelihood, and independent-channel behavior for local quality scoring.
...
- UI exposes live meter speech/noise/SNR/hum/static/clipping/channel correlation cues plus recording and schedule quality timelines with event-specific watchdog and upload-failure evidence.
- Prometheus export covers health totals, active watchdog alerts, node-offline alerts, xrun totals, clipping, speech score, noise score, estimated SNR, hum score, static score, and channel correlation score.
...
| Meter speech/noise/SNR/hum/static/clipping UI helpers | `apps/web/src/lib/meter-helpers.test.ts` |
...
| Agent meter quality, speech/noise/SNR/hum/static/channel correlation, clipping, synthetic PCM calibration | `crates/recorder-agent/src/telemetry.rs` |
