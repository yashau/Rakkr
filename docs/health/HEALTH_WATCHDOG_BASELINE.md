...
| Agent capture growth, cache upload, job claim-next/status-poll/control-plane/channel-map failure, render-failure, and system-health smoke | `scripts/agent-fake-controller-smoke.mjs` |
