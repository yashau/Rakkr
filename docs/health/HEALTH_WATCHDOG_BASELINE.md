...
| Agent capture growth, cache upload, job claim-next/status-poll failure, render-failure, and system-health smoke | `scripts/agent-fake-controller-smoke.mjs` |
