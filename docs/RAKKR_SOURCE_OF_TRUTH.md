...
| Recorder agent | 🟨 | Inventory, S16/S32 meters, controller capacity polling, bounded concurrent jobs, capture growth guards, profile rendering, clipping/flatline/low-signal/channel-correlation health, concurrent-safe health log, hardware-derived health-event controller sync |
