...
344. ✅ Add fake-controller smoke coverage for agent node-config, node-heartbeat, and recording-job claim-next/status-poll failure/recovery health.
## Open Questions
