...
| Storage upload | 🟦 | Stub queue, provider config/status, policy templates, UI actions, metrics |
...
1. 🚧 Add automatic queueing when cached recordings match enabled upload policies.
