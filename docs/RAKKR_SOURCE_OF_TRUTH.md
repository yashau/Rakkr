...
1. Add recording-job backend/file-writer health events so failed captures become first-class alerts.
2. Add disk/CPU/audio backend health sampling for the node health dashboard.
