...
| Scheduler            | 🟦 Scaffold  | Persistent store, create/edit/run-now/skip/delete UI, metadata ownership, recurrence editing, paused ranges, quick text helpers, previews, timeline, and due runner |
...
1. Add schedule execution detail pages with recording/job/health correlation.
