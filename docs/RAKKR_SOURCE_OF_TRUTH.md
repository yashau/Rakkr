...
- Agent runtime inventory reports detected PipeWire and JACK command availability, both have managed capture/meter backend presets, and ALSA metering supports both `S16_LE` and `S32_LE` PCM, including X32 X-USB 32-channel S32 meter frames.
...
342. ✅ Add Debian ALSA loopback short/long, X32 S32 meter, X32 hardware short/long, and onboard HDA full-agent job smokes.
