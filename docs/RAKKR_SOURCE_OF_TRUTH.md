...
| Health watchdog      | 🟦 Scaffold  | Health event model, lifecycle actions, node meter ingest, clipping/flatline/xrun/device-unavailable agent events, scheduled low-signal runner, quality timelines, and recording health sync exist |
...
1. Add richer recurrence helper coverage after real scheduling examples accumulate.
