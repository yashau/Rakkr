...
- Dockerized Ansible lifecycle runner smoke reached the X32 Debian rig at `172.22.145.152` as root with the mounted user-profile SSH key and ran `/tmp/rakkr-recorder-agent --print-inventory`, reporting the X-USB 32-channel ALSA interface.
