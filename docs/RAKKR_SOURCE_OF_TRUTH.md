...
| Controller UI        | 🟦 Scaffold  | Dashboard plus node enrollment, node health summaries/drilldown, jobs, metadata editing, filters, schedule editing, execution detail, and quality timelines |
...
- [ ] 🟦 Node health dashboard summaries and event drilldown.
...
1. Add deeper node health trends and event drilldown from the node health dashboard.
