...
| Scheduler            | 🟦 Scaffold  | Persistent store, create/edit/run-now/skip/delete UI, metadata ownership, recurrence editing, buffers, previews, timeline, and due runner |
...
1. Add paused date ranges and natural-language recurrence helpers on top of structured schedules.
2. Add schedule execution detail pages with recording/job/health correlation.
