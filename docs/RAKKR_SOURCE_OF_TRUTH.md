...
| Scheduler            | 🟦 Scaffold  | Persistent store, create/edit/run-now/skip/delete UI, metadata ownership, recurrence editing, buffers, and due runner |
...
1. Add richer occurrence previews and due-run timeline visibility in the Schedules UI.
2. Add paused date ranges and natural-language recurrence helpers on top of structured schedules.
