...
| Health watchdog      | 🟦 Scaffold  | Health event model, lifecycle actions, node meter ingest, clipping/flatline/xrun/device-unavailable/job failure events, scheduled low-signal runner, quality timelines, and recording health sync exist |
...
1. Add disk/CPU/audio backend health sampling for the node health dashboard.
