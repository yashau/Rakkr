...
| Controller UI        | 🟦 Scaffold  | Dashboard plus node enrollment, node health summaries, jobs, metadata editing, filters, schedule editing, execution detail, and quality timelines |
...
- [ ] 🟦 Node health dashboard summaries.
