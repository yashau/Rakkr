...
- Linux `snd-aloop` smoke tasks can validate WAV capture, agent meters, render/channel-map output, and clean/clipping/low-volume/channel-correlation fixture replay plus daemon health-log events on a recorder node.
