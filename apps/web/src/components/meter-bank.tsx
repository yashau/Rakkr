          ...
          return (
            ...
            >
              ...
              <div className="relative h-8 overflow-hidden rounded-md border border-border bg-muted">
                ...
                />
                <div
                  className="absolute inset-y-1 w-0.5 rounded-full bg-foreground/70 shadow-[0_0_10px_rgba(24,24,27,.35)]"
                ...
                {channel.clipping ? (
                  <div className="absolute inset-y-0 right-0 flex w-7 items-center justify-center bg-destructive text-destructive-foreground">
              ...
              {channel.speechPercent !== undefined || channel.noisePercent !== undefined ? (
                <>
                  ...
                  <div className="flex flex-wrap gap-2 text-xs text-muted-foreground">
                    ...
                    {channel.broadbandNoisePercent !== undefined ? (
                      <span>broadband {channel.broadbandNoisePercent}%</span>
                    ) : null}
...
function MeterStat({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border border-border bg-transparent px-3 py-2">
