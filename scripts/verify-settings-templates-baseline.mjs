...
const sourceFiles = [
  ...
  "apps/api/src/watchdog-policy-settings.ts",
  "apps/web/src/components/schedule-form-dialog.tsx",
...
const sourceSnippets = [
  ...
  "recordingProfileCreateSchema",
  "watchdogPolicyCreateSchema",
  "recordingProfileFromInput",
  "watchdogPolicyFromInput",
  "createRecordingProfile",
  "createWatchdogPolicy",
  "api.createRecordingProfile",
  "api.createWatchdogPolicy",
  "defaultRecordingProfileInput",
  "defaultWatchdogPolicyInput",
