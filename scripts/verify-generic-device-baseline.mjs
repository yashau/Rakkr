...
const sourceFiles = [
  ...
  "apps/api/src/node-inventory-routes.ts",
  ...
  "apps/api/test/node-inventory-routes.test.ts",
  ...
  "crates/recorder-agent/src/channel_map/tests.rs",
  ...
  "scripts/agent-alsa-job-smoke.sh",
...
const baselinePhrases = [
  ...
  "Ad-hoc recording starts can pin capture backend",
  "Schedules can pin a target audio interface",
  "capture backend",
  "hyphen-leading template values",
  "Fake-controller smoke coverage",
  "arecord",
  "/proc/asound/pcm",
  "inventory probe command and `/proc/asound/pcm` path can be pinned",
  ...
  "PipeWire",
  "JACK",
  "keeping `unknown` only when no real backend is known",
  "sysfs hardware paths",
  "Node inventory can filter visible recorder nodes by audio backend",
  "Synthetic meters",
  "fake-controller",
...
const sourceSnippets = [
  ...
  "RAKKR_INVENTORY_ARECORD_COMMAND",
  "RAKKR_INVENTORY_PROC_ASOUND_PCM_PATH",
  ...
  "inventory_arecord_command",
  "inventory_proc_asound_pcm_path",
  "dump-hw-params",
  ...
  "runtime_audio_backends_drop_unknown_when_real_backend_available",
  "nodeMatchesBackend",
  "node list filters by audio backend",
  "nodeBackendFilter",
  "all backends",
  ...
  "agent:loopback-fixture-smoke",
  "agent:loopback-job-smoke",
  "agent:loopback-longrun-smoke",
  "agent:alsa-capture-smoke",
  "agent:alsa-meter-smoke",
  "agent:x32-meter-smoke",
  "agent:x32-meter-soak",
  "agent:x32-low-signal-health-smoke",
  "agent:x32-low-signal-health-sync-smoke",
  "agent:alsa-job-smoke",
  "agent:x32-job-smoke",
  "agent:x32-longrun-job-smoke",
  "agent:alsa-pch-meter-smoke",
  "agent:alsa-pch-flatline-health-smoke",
  "agent:alsa-pch-flatline-health-sync-smoke",
  "agent:alsa-pch-job-smoke",
  "RAKKR_ALSA_CAPTURE_DEVICE",
  "RAKKR_ALSA_JOB_DEVICE",
  "RAKKR_ALSA_JOB_EXPECT_CARD",
  "RAKKR_ALSA_METER_FORMAT",
  "RAKKR_ALSA_METER_ITERATIONS",
  "RAKKR_ALSA_METER_INTERVAL_SECONDS",
  "RAKKR_X32_METER_SECONDS",
  "RAKKR_X32_METER_SOAK_ITERATIONS",
  "RAKKR_X32_HEALTH_RUN_SECONDS",
  "RAKKR_ALSA_PCH_METER_SECONDS",
  "RAKKR_ALSA_PCH_HEALTH_RUN_SECONDS",
  "RAKKR_ALSA_PCH_JOB_SECONDS",
  "RAKKR_X32_LONGRUN_JOB_SECONDS",
  "RAKKR_LOOPBACK_REQUIRE_SND_ALOOP",
  "RAKKR_LOOPBACK_PLAYBACK_MODE",
  ...
  "RAKKR_LOOPBACK_LONGRUN_SECONDS",
  "stream_loop",
  "X32 full-agent job smoke",
  ...
  "ALSA PCH full-agent job smoke",
  "agent did not upload exactly one cache file",
  "uploaded WAV mean volume was too quiet",
  "snd-aloop",
  "speaker-test",
  "ffprobe",
  "--print-meter-frame",
