...
const testSnippets = [
  ...
  "keeps a scheduled recording window as a single track for chunked capture",
  "scheduled recording completes through agent cache attach and exposes schedule-owned media",
  "due schedule creates one chunked recording when the profile sets a chunk length",
  "captureBackend",
  "captureInterfaceId",
  "retentionPolicyId",
