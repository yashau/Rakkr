...
const sourceFiles = [
  ...
  "crates/recorder-agent/src/agent_recovery.rs",
  ...
  "scripts/agent-fake-controller-smoke-controller.mjs",
  "scripts/agent-fake-controller-smoke-health.mjs",
  "scripts/agent-fake-controller-smoke-health-system.mjs",
  "scripts/agent-fake-controller-smoke-health-meters.mjs",
...
const baselinePhrases = [
  ...
  "fault scores",
  "explicit `df` command and loadavg paths",
  "controller Date clock-skew warning/recovery",
  "controller-synced generic meter capture-failed, xrun, device-unavailable, and recovery health with synthetic fallback",
  "audio-backend unavailable/recovery details",
  "disk/CPU pressure and recovery plus controller Date clock-skew warning/recovery and audio-backend unavailable/recovery detail transitions",
  "controller-synced audio-backend unavailable/recovery health with refreshed inventory probes",
  "stalled-capture structured growth evidence and render-failure command/output evidence",
  "controller-synced node-heartbeat, meter-frame, listen-monitor chunk metadata, and node-config polling failure/recovery evidence",
  ...
  "cache upload failure with upload/output evidence",
  "channel-map application sync",
...
const sourceSnippets = [
  ...
  "CLOCK_SKEW_WARNING_SECONDS",
  "CLOCK_SKEW_RECOVERY_SECONDS",
