...
const baselinePhrases = [
  ...
  "stub, mounted-share SMB, and S3 targets",
  "SHA-256",
  "ChecksumSHA256",
  "Provider readiness",
  "retry budget",
...
const testSnippets = [
  ...
  "uploads SMB queue items to a mounted filesystem target",
  "uploads S3 queue items with bucket, key, and recording metadata",
